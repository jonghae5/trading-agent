...
export const IndicatorGroups = {
  ...
  EMPLOYMENT: ['UNRATE', 'PAYEMS', 'ICSA', 'JTSJOL', 'JTSQUR', 'JTSHIR'],
  INFLATION: ['CPIAUCSL', 'PCEPI', 'PCEPILFE', 'T5YIE', 'T10YIE', 'DFII10'],
  ...
  REAL_ESTATE: ['MORTGAGE30US', 'MORTGAGE15US', 'NYUCSFRCONDOSMSAMID'],
  MARKET_SENTIMENT: ['VIXCLS', 'UMCSENT', 'USREC', 'DPHILBSRMQ'],
  FISCAL_GLOBAL: ['GFDEGDQ188S', 'GFDEBTN', 'DTWEXBGS', 'DGS30']
} as const
