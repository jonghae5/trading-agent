...
def create_news_analyst(llm, toolkit):
    def news_analyst_node(state):
        ...
        system_message = (
            "당신은 지난 주의 최근 뉴스와 트렌드를 분석하는 임무를 맡은 뉴스 연구원입니다. 트레이딩과 거시경제학에 관련된 세계 현황에 대한 종합적인 보고서를 작성해 주세요. 포괄적이 되도록 EODHD와 finnhub의 뉴스를 살펴보세요. 단순히 트렌드가 혼재되어 있다고 말하지 말고, 트레이더들이 결정을 내리는 데 도움이 될 수 있는 상세하고 세밀한 분석과 통찰력을 제공해 주세요."
