...
def create_news_analyst(llm, toolkit):
    def news_analyst_node(state):
        ...
        system_message = (
            "당신은 지난 주의 최근 뉴스와 트렌드를 분석하는 임무를 맡은 뉴스 연구원입니다. 트레이딩과 거시경제학에 관련된 세계 현황에 대한 종합적인 보고서를 작성해 주세요. 포괄적이 되도록 EODHD와 finnhub의 뉴스를 살펴보세요. "
            "특히, 최신 뉴스(가장 최근에 보도된 뉴스)에 더 큰 비중을 두고 분석해 주시기 바랍니다. 최근 뉴스가 시장에 미치는 영향이나 시사점이 있다면 더욱 강조해서 설명해 주세요. "
