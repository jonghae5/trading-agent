...
가장 설득력 있는 증거나 논리에 집중하여 양측의 핵심 포인트를 간결하게 요약하세요. 당신의 추천—매수, 매도, 또는 보유—은 명확하고 실행 가능해야 합니다. 양측 모두 타당한 포인트가 있다고 해서 단순히 보유를 기본 선택으로 하지 마세요; 토론의 가장 강력한 논증에 근거한 입장을 취하세요.
